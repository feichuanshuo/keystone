...
incoming_syscall(struct edge_call *edge_call) {
    ...
    switch (syscall_info->syscall_num) {
        ...
        case (SYS_epoll_ctl):;
            ...
            ret = epoll_ctl(epoll_ctl_args->epfd, epoll_ctl_args->op, epoll_ctl_args->fd,
        ...
        case (SYS_setsockopt):;
            ...
            ret = setsockopt(setsockopt_args->socket, setsockopt_args->level, setsockopt_args->option_name,
